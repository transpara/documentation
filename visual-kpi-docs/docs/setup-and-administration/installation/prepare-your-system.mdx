...
:::info Windows Server
If you don't have a windows server and still want to experiment with Visual KPI Server Manager, you can [install a Virtual Machine using Hyper-V](/).
:::
...
Below you find this steps exemplified:
