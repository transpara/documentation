...
Groups are how your information is organized, a key form of navigation. Groups are also the primary view of the hierarchy. Some of the icons you see in Groups are universal. Others only show up if they have been turned on and/or configured in the Visual KPI Designer. And still, others show up depending on what types of KPIs or data you are viewing.
...
:::note
If KPIs, Charts or Tables exist at each level, they will be shown below the groups.

<StylizedImage
  imgURL="img/docs/end-user/basic-navigation/visualization/group-visualization.gif"
  alt="Show how KPIs, Charts, and tables are displayed below groups."
/>
:::
